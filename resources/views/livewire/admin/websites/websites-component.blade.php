        ...
        <li>
          <div class="flex items-center">
            <a href="{{ route('dashboard') }}"
              class="text-sm font-medium text-gray-500 hover:text-gray-700 transition-colors">{{ __('Dashboard') }}</a>
          </div>
        </li>
        <li>
          <div class="flex items-center">
            ...
            <span class="ml-2 text-sm font-medium text-gray-700" aria-current="page">{{ __('Websites') }}</span>
          </div>
        </li>
      </ol>
    </nav>
    ...
    <div class="mt-6">
      ...
      <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
          <h1 class="text-2xl font-semibold text-gray-900">{{ __('Websites') }}</h1>
        ...
        <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
          <a href="{{ route('websites.create') }}"
            class="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-colors sm:w-auto">
          ...
          <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
            ...
            <div class="sm:col-span-2">
              <label for="type_filter"
                class="block text-sm font-medium text-gray-700 mb-1">{{ __('Website Type') }}</label>
            ...
            <div class="sm:col-span-1">
              <label for="auth_filter"
                class="block text-sm font-medium text-gray-700 mb-1">{{ __('Auth Type') }}</label>
                  ...
                  @forelse($websites as $website)
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <div class="flex items-center">
                          <div class="h-10 w-10 flex-shrink-0">
                            <div class="h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center">
                              ...
                              <svg class="h-6 w-6 text-gray-400 hidden" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          ...
                          <div class="ml-4">
                            <div class="font-medium text-gray-900">
                              <a href="{{ $website->url }}" target="_blank" rel="noopener noreferrer"
                                ...
                                {{ $website->url }}
                                <svg class="inline h-3 w-3 ml-1 text-gray-400" fill="none" stroke="currentColor"
                                  viewBox="0 0 24 24">
                                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      ...
                      <td class="px-3 py-4 text-sm text-gray-500">
                        @if ($website->api_url)
                          <div class="max-w-xs truncate">
                            <a href="{{ $website->api_url }}" target="_blank" rel="noopener noreferrer"
                              class="text-indigo-600 hover:text-indigo-500 font-mono text-xs">
                              {{ $website->api_url }}
                              <svg class="inline h-3 w-3 ml-1" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                  d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14">
                                </path>
                        ...
                        @else
                          <span class="text-gray-400 text-xs">{{ __('No API URL') }}</span>
                        @endif
                      </td>
                      <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        @php
                        ...
                        @endphp
                        <span
                          class="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-{{ $auth['color'] }}-100 text-{{ $auth['color'] }}-800">
                      ...
                      <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        <div class="flex flex-col">
                          <span class="font-medium">{{ $website->created_at->format('M d, Y') }}</span>
                          <span class="text-xs text-gray-400">{{ $website->created_at->format('g:i A') }}</span>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td colspan="6" class="px-6 py-12 text-center">
                        <div class="flex flex-col items-center">
                          ...
                          <h3 class="text-sm font-medium text-gray-900 mb-1">{{ __('No websites found') }}</h3>
