<div class="p-4 sm:p-6 lg:p-8">
  ...
  <div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Market</h1>
    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Update market information and configuration</p>
  </div>
    ...
    <form wire:submit="update">
      <div class="p-6 space-y-6">
        ...
        <div class="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
          <h3 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Market Information</h3>
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              <span class="text-gray-500 dark:text-gray-400">Created:</span>
              <span
                class="text-gray-900 dark:text-white ml-2">{{ $market->created_at->format('M d, Y \a\t g:i A') }}</span>
            </div>
            <div>
              <span class="text-gray-500 dark:text-gray-400">Last Updated:</span>
              <span
                class="text-gray-900 dark:text-white ml-2">{{ $market->updated_at->format('M d, Y \a\t g:i A') }}</span>
            </div>
            <div>
      ...
      <div class="px-6 py-4 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 rounded-b-lg">
        <div
          ...
          <button type="submit"
            ...
            <span wire:loading.remove>Update Market</span>
