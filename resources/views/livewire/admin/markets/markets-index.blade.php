<div class="p-4 sm:p-6 lg:p-8">
  ...
  <div class="sm:flex sm:items-center sm:justify-between mb-6">
    <div>
      ...
      <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Manage your markets and their configurations</p>
    </div>
    ...
    <div class="p-4 sm:p-6">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="sm:col-span-2">
          ...
          <div class="relative">
            <input type="text" wire:model.live.debounce.300ms="search" placeholder="Search by name or ISO code..."
            ...
            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <span
                  ...
                  {{ strtoupper($market->iso_code) }}
                </span>
              </td>
              {{-- <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                {{ $market->websites->count() }} websites
              </td> --}}
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                {{ $market->created_at->format('M d, Y') }}
              </td>
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <div class="flex items-center justify-end space-x-2">
                  ...
                  <button wire:click="confirmDelete({{ $market->id }})"
            ...
            <tr>
              <td colspan="5" class="px-6 py-8 text-center">
                <div class="text-gray-500 dark:text-gray-400">
                  ...
                  <p class="text-sm">Get started by creating your first market.</p>
                </div>
              </td>
            </tr>
          @endforelse
      ...
      <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            ...
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div class="mt-2">
                <p class="text-sm text-gray-500 dark:text-gray-400">
                  Are you sure you want to delete <strong>{{ $marketToDelete?->name }}</strong>? This action cannot be
                  undone.
                </p>
              </div>
            </div>
          ...
          <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
            <button wire:click="deleteMarket" type="button"
