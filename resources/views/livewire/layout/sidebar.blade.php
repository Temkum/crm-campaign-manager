<nav
  ...
  <div class="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
    <div class="flex items-center space-x-2">
      ...
      <span class="text-lg font-semibold text-gray-900 dark:text-gray-400">Livewire</span>
    </div>
  ...
  <div class="p-4 space-y-2">
    ...
    @foreach ($navItems as $item)
      @php
        ...
        $inactiveClasses =
            'flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors text-gray-700 dark:text-gray-200 hover:text-gray-900 dark:hover:text-gray-100';
      @endphp
